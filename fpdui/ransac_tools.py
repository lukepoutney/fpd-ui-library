...
def ransac_im_fit(im, mode=1, residual_threshold=0.1, min_samples=10,
    ...
    if mode == 0:
        ...
        # linear
        model_class = fpd.ransac_tools._Plane3dModel
    elif mode == 2:
        # quadratic
        model_class = fpd.ransac_tools._Poly3dModel
    elif mode == 3:
        # concave paraboloid
        model_class = fpd.ransac_tools._Poly3dParaboloidModel
    elif mode == 4:
        # spline
